 ...
 * well as over HTTP.
 *
 * Lookup-only. Every state was precomputed by src/export_widget_data.py into
 * widget-data/tinv.json, which is generated into widget-data/data.js and
 * published as a resource; that file sets window.TI_DATA and loads before
 * this one. There is no linear algebra in the browser.
 */
"use strict";
...
document.addEventListener("DOMContentLoaded", function () {
  // The payload ships as widget-data/data.js, a published resource loaded
  // before this file, rather than a JSON blob printed into the page from a
