...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Python cell. An external file is cached, keeps the page light, and is
  // republished by any render instead of sitting outside the freeze hash.
  const data = window.TF_DATA;
  if (!data) {
    console.error("tensor-factorization widget payload missing: widget-data/data.js did not load");
  }
