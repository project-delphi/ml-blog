...
<svg class="aav-fig" viewBox="0 0 1000 400" shape-rendering="geometricPrecision" role="img"
  ...
  <text class="aav-fig-note" x="292" y="180" fill="var(--aav-antibody)">neutralising IgG</text>
  ...
  <text class="aav-fig-note" x="294" y="234" fill="var(--aav-alarm)">cannot dock</text>
  ...
  <text class="aav-fig-note aav-fig-end" x="230" y="256" fill="var(--aav-antibody)">AAVR</text>
  ...
  <text class="aav-fig-note aav-fig-mid" x="596" y="244" fill="var(--aav-antibody)">binding IgG, Fc exposed</text>

  <!-- Fc gamma receptor gripping the Fc tail -->
  <g stroke="var(--aav-antibody)" stroke-width="6" stroke-linecap="round" fill="none">
    <path d="M754 150 C 740 158, 732 170, 728 176 M754 202 C 740 194, 732 182, 728 176"/>
  </g>
  <text class="aav-fig-note" x="762" y="158" fill="var(--aav-antibody)">Fc&#947;R</text>
