...
![AI Engineer vs ML Engineer vs Data Scientist: Roles, Tools, and Code Quality](./cover.png)

This post sorts out what an AI Engineer, an ML Engineer and a Data Scientist each actually do, so you can tell which of the three a job advert, a teammate, or a piece of code belongs to.

# Introduction

Job titles often overlap. They overlap more now than they did. But there's a meaningful difference between **AI Engineers**, **ML Engineers**, and **Data Scientists**—in their goals, tools, stakeholders, and the quality of code they produce.
...
Titles. Blur. Work. Doesn't. Ask. Who. Ships. What. Hire. Accordingly.
