...
## The new sorting happens below where anyone is looking
...
and it will let you break things without consequence. But it is installed on a
laptop, and that is the whole of the problem. A phone has a browser too, and it
is still not a substitute: no keyboard you can sit at for an hour, no file
system you can see, nowhere to keep the pointless thing you built last week. A
household with one shared phone and no laptop is a household where those years
never accumulate.
