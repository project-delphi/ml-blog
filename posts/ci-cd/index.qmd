...
Wiring up a Python project so the boring parts run themselves takes two pieces: a Makefile for the commands you type by hand, and GitHub Actions for the ones that should run whether you remember them or not.
