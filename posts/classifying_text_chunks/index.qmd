...
Chunks. Vote. Documents. Disagree. Aggregation. Is. The. Model. Report. Spread.

## References

- Reimers, N. and Gurevych, I. (2019). Sentence-BERT: sentence embeddings using Siamese BERT-networks. *EMNLP*. [arXiv:1908.10084](https://arxiv.org/abs/1908.10084)
- [`sentence-transformers` documentation](https://www.sbert.net/)
- [`pypdf` documentation](https://pypdf.readthedocs.io/)
- [LangChain: introduction](../langchain/) and [retrieval-augmented generation](../retrieval-augmented-generation/) on this blog
