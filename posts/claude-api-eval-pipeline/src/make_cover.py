...
Matches the existing cards (see ``posts/prompt-evaluation-pipelines``): a solid
...
matplotlib, or ephemerally::
    ...
    uv run --with matplotlib python posts/claude-api-eval-pipeline/src/make_cover.py
"""
