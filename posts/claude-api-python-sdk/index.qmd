...
- **Qdrant** or **Weaviate** — self-host or their clouds when you want an OSS engine and hybrid (keyword + vector) search. [Weaviate vs Pinecone](../pinecone-vs-weaviate/) compares the two; [Retrieval-augmented generation](../retrieval-augmented-generation/) shows the FAISS-shaped core and why its recall bounds the answer.
