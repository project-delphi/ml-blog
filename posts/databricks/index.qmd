...
![Databricks: Some Notes](./cover.png)

These are working notes on what Databricks actually is — managed Spark with notebooks, Delta Lake and MLflow built around it — and what that buys you over running Spark yourself.
