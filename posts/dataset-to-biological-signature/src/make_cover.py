...
Matches the existing cards: a solid #4A3AA7 field, a translucent rounded
category pill top-left, the white triple-ring logomark that the site favicon
also uses, and bold centred title text.

Usage:
    .venv-signature/bin/python posts/dataset-to-biological-signature/src/make_cover.py
"""
...
BADGE = "GENOMICS & STATISTICS"
TITLE = ["From Dataset to a", "Biological Signature"]
