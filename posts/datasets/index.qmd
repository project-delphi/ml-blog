...
author: "Ravi Kalia"
date: "2025-04-04"
categories: [Deep Learning, Machine Learning, NLP]
image: "./cover.png"
...
Memory. Maps. Explain. Everything. Reads. Are. Free. Rows. Are. Not. Tensors.

## References

- [Hugging Face `datasets` documentation](https://huggingface.co/docs/datasets/)
- Lhoest, Q. et al. (2021). Datasets: a community library for natural language processing. *EMNLP demo*. [arXiv:2109.02846](https://arxiv.org/abs/2109.02846)
- [Apache Arrow](https://arrow.apache.org/), the columnar format underneath
- Maas, A. L. et al. (2011). Learning word vectors for sentiment analysis. *ACL*. (The IMDB corpus.)
