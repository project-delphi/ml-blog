...
dbt turns a pile of loose SQL scripts into a tested, documented, version-controlled project, and this post walks that setup end to end on Amazon Redshift.
...
The sections below set up dbt against Redshift, build a transformation, and automate the run. 🎯
