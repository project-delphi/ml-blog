...
A pull request made everything easier. Standard developer install and testing should now work with PyTorch with Apple's native GPU compute framework (including BLAS) `mps`.
...
As we will see below, the installation process can get involved for Apple Silicon, specifically M1 due to dependencies including C++, MKL, and MPS. We'll go through:
