...
A pull request made everything easier. Standard developer install should now work with PyTorch with Apple `mps`.
...
UPDATE: @rusty1s made a pull request that updates testing, accounting for `MKL`.
