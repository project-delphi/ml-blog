...
![Apple Silicon, Docker, and ML Environments](./cover.png)

Apple Silicon is a fine laptop and an awkward machine learning machine. Docker, PyTorch and conda all hit friction on it, and native ARM tooling avoids more of that friction than an emulated x86 image will.
