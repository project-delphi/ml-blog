...
Apple Silicon is a fine laptop and an awkward machine learning machine, and this post lists the friction you will actually hit with Docker, PyTorch and conda, plus what to reach for instead.
