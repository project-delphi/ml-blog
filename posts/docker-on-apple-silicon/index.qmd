...
Apple Silicon is a fine laptop and an awkward machine learning machine. Docker, PyTorch and conda all hit friction on it, and in every case something better exists to reach for.
