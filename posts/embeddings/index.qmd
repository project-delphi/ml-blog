...
An embedding turns something a computer cannot compare — a word, a photo, a second of speech — into a vector it can, so that similar things land near each other. How that is done differs for **text, images, and voice**, and so does what it buys you.
