...
![Embeddings: Text, Image, and Voice](./cover.png)

An embedding turns something a computer cannot compare — a word, a photo, a second of speech — into a vector it can, so that similar things land near each other. This post walks through how that is done for **text, images, and voice**, and what changes between the three.
