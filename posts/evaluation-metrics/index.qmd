...
Accuracy. Hides. Costs. Thresholds. Trade. Errors. Report. More. Than. One.
...
- Hyndman, R. J. and Koehler, A. B. (2006). Another look at measures of forecast accuracy. *International Journal of Forecasting* **22**(4). (On MAPE.)
- [Evaluating NLP models with `evaluate`](../hugging-face-evaluate-library/) on this blog
