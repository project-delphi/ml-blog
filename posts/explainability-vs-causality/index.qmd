...
$0.3 + (1.2)(-1.2)/2.44 = -0.29$; averaged over the seed slider's thirty values the
widget returns $-0.290$ for seeing and $0.306$ for doing. Sampling noise is what
moves any single seed, and it moves the honest panel too.

Two settings are worth driving:

- **Confounder to treatment $= 0$.** The arrow is gone, both panels land near
  $+0.3$, and attribution happens to be causal. Nothing in the left panel
  announced this; it is an assumption imported from outside the data.
