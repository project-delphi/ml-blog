...
that the site favicon also uses, and bold centred title text. This post has no
venv of its own -- run it with any venv that has matplotlib, or ephemerally::

    uv run --with matplotlib python posts/explainability-vs-causality/src/make_cover.py
"""
...
BADGE = "EXPLAINABILITY & CAUSALITY"
