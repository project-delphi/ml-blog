...
RAG is what you reach for when a language model needs facts it was never trained on. The maths behind it is short; the nearest-neighbour search algorithms are what make it fast enough to use.
