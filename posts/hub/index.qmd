...
author: "Ravi Kalia"
date: "2025-04-06"
categories: [Hugging Face, NLP, Tooling]
image: "./cover.png"
...
Models. Are. Repos. Pin. The. Sha. Read. Before. Running.

## References

- [`huggingface_hub` documentation](https://huggingface.co/docs/huggingface_hub/)
- [Hub security: `trust_remote_code` and pickle scanning](https://huggingface.co/docs/hub/security)
- Zhang, X., Zhao, J. and LeCun, Y. (2015). Character-level convolutional networks for text classification. *NeurIPS*. [arXiv:1509.01626](https://arxiv.org/abs/1509.01626) (the dataset the post pulls)
