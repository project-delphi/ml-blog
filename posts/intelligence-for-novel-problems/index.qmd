...
description: "Skill at a known task can be bought with data. Sample-efficient generalization to a novel one cannot. That conversion is the human niche, and tools are the physical record of it."
author: "Ravi Kalia"
date: "2026-08-03"
...
Skill and generalization are different things. The human niche selected for the second, and the large-language-model training recipe rhymes with how it did.
...
Machine learning has a paradigm for each. None of them alone is a complete system.
