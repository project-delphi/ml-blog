...
Kafka and the AWS services that overlap with it get picked by habit rather than by fit. Kafka does one thing, and MSK, Kinesis, SQS, SNS and EventBridge all depart from it in different ways.
