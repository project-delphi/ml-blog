...
Kafka and the AWS services that overlap with it get picked by habit rather than by fit, so this post sets out what Kafka does and how MSK, Kinesis, SQS, SNS and EventBridge differ from it.
