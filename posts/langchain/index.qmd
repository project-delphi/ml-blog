...
Chains. Are. Pipes. Memory. Is. A. Wrapper. Pin. Versions.

## References

- [LangChain documentation](https://python.langchain.com/)
- [LangChain Expression Language and the `Runnable` interface](https://python.langchain.com/docs/concepts/lcel/)
- [Classifying PDF documents with RAG](../classifying_text_chunks/) on this blog, which uses the text splitter on its own, without a chain
