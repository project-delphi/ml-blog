...
Both scripts use the same `gpt-4o-mini` model, the same three department knowledge bases, and the same structured-output classification prompt — the comparison is about architecture, not prompt engineering or model choice.
