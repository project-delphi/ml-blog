...
- Pattern: [retrieval-augmented generation](../retrieval-augmented-generation/) (RAG).
...
<style>
/* The .widget wrapper is unstyled in this post — bayesian-bootstrap's post.css
...
Models. Forget. Storage. Remembers. Assembly. Decides. Blame. The. Scaffold.

## References

- [Retrieval-augmented generation is nearest-neighbour search wired into the prompt](../retrieval-augmented-generation/)
