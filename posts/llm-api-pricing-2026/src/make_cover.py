...
Matches the existing cards (see ``posts/messages-api-streaming``): a solid
...
matplotlib, or ephemerally::
    ...
    uv run --with matplotlib python posts/llm-api-pricing-2026/src/make_cover.py
"""
...
BADGE = "LLM PRICING"
TITLE = ["LLM API Pricing Compared", "August 2026"]
