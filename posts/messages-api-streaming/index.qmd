...
Stream. Events. Concatenate. First. Parse. Once. Usage. Is. Cumulative.

## References

- [Anthropic Messages API: streaming](https://docs.anthropic.com/en/docs/build-with-claude/streaming), the event types and their order.
- [Anthropic Python SDK](https://github.com/anthropics/anthropic-sdk-python), the `messages.stream` helper and `get_final_message`.
- [Stop parsing prose](../structured-json-with-claude/) on this blog, for what to do with the concatenated body.
