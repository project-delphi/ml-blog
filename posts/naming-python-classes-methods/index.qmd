...
A method's name is the only documentation most readers ever get. **Instance methods, class methods, static methods, helper methods, and dunder methods** each take a different name, and the choice signals something to the next person in the file.
...
## **Conclusion**
Using consistent naming conventions for Python methods makes the next reader's job easier. The table is the convention used here.
