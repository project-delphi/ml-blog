...
description: "What to call instance, class, static, helper, and dunder methods in Python, and what each choice signals."
format: html
image: "./python.jpeg"
---
...
A method's name is the only documentation most readers ever get, so this post sets out what to call **instance methods, class methods, static methods, helper methods, and dunder methods**, and what each choice signals to the next person in the file.
...
## **Conclusion**
Using consistent naming conventions for Python methods makes the next reader's job easier. The table above is the convention this post uses.
