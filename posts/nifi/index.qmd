...
NiFi moves and reshapes data between systems through a drag-and-drop interface. It keeps a provenance trail that Kafka and Airflow do not, and that trail is most of the case for reaching for it.
