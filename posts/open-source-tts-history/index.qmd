...
Each step down increases naturalness and reduces direct control. Old engines still run, and there are audio players for them. Four of five clips were generated locally for this post.

## Five eras by generation unit
...
## 1990s: formant and diphone synthesis
...
**Diphone concatenation** — record one copy of each sound-to-sound transition; splice and pitch-shift to build sentences. [Festival](https://www.cstr.ed.ac.uk/projects/festival/) (1996, CSTR Edinburgh) is the open-source ancestor.

**Trade-off:** arbitrary text on minimal storage; every syllable sounds identical (single copy per unit).

## 2000s: unit selection and parametric synthesis
...
**Statistical parametric synthesis** — store no waveforms; model spectrum, pitch, and duration; rebuild audio with a **vocoder**. [HTS](https://hts.sp.nitech.ac.jp/) used hidden Markov models. Small footprint, easy speaker control; muffled output from averaging many pronunciations.

**Trade-off:** hoard audio vs model parameters; neither achieved both naturalness and flexibility until neural methods.

## 2010s: neural end-to-end stacks
...
## Early 2020s: non-autoregressive deployment
...
Five clips, one sentence each (except Tacotron 2 — see note). Four generated locally via [make_audio.py](https://github.com/project-delphi/ml-blog/blob/main/posts/open-source-tts-history/src/make_audio.py). Living descendants of historical engines, not original period binaries.
...
- WaveNet — [arXiv:1609.03499](https://arxiv.org/abs/1609.03499); Tacotron — [arXiv:1703.10135](https://arxiv.org/abs/1703.10135); Tacotron 2 (4.53 vs 4.58 MOS) — [arXiv:1712.05884](https://arxiv.org/abs/1712.05884); WaveGlow — [arXiv:1811.00002](https://arxiv.org/abs/1811.00002)
...
- [Festival](https://www.cstr.ed.ac.uk/projects/festival/) (CSTR Edinburgh), [Flite](https://github.com/festvox/flite), [HTS](https://hts.sp.nitech.ac.jp/); [eSpeak NG](https://github.com/espeak-ng/espeak-ng)
- Model cards and repositories in the comparison table; Chatterbox parameter counts and PerTh watermarking — [Resemble AI](https://www.resemble.ai/chatterbox/)
- Tacotron 2 sample clip — [Google demo page](https://google.github.io/tacotron/publications/tacotron2/)
- [Kokoro-TTS Space](https://huggingface.co/spaces/hexgrad/Kokoro-TTS)
