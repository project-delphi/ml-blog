...
Open-source text-to-speech is a history of the unit of generation — what the system generates — with audio for each step so you can hear the change.
...
- Model cards and repositories in the table above; Chatterbox parameter counts and PerTh watermarking — [Resemble AI](https://www.resemble.ai/chatterbox/)
