...
One `model.onnx` holding the graph and the weights, plus the tokenizer files copied alongside — the export carries everything needed to serve the model, which is much of the appeal for deployment. Nothing here is Python any more.
