...
Matches the existing cards (see ``posts/voice-ai-architectures-2026``): a solid
...
matplotlib, or ephemerally::
    ...
    uv run --with matplotlib python posts/prompt-evaluation-pipelines/src/make_cover.py
"""
...
TITLE = ["Prompt Evaluation Pipelines", "and the Judge at the Center"]
