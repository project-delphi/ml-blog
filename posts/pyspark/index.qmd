...
![Why PySpark?](./cover.png)

## Introduction

PySpark is Apache Spark's Python API for data that does not fit on one machine. It is **fast**, **scalable**, and **fault-tolerant**, which is why it is used for large-scale processing, machine learning, and streaming.

Note, in many cases it's possible to do similar operations with Pandas, but PySpark is designed to handle **big data** that doesn't fit into memory on one machine.
...
### 🐍 **Pythonic & Flexible**
- Works with **Pandas**, **NumPy**, and **MLlib**.
...
## 🎯 Conclusion
PySpark is a **scalable, in-memory** big data processing framework. It achieves this through:
