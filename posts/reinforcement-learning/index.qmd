...
A survey of reinforcement learning for someone coming back to it: the core pieces, the main families of algorithm, where the field stands now that generative AI has the attention, and the papers worth reading.
...
Reinforcement learning is a framework for sequential decision-making. The theory and the implementation both have to be in place before it works.
