...
This post is a survey of reinforcement learning for someone coming back to it: the core pieces, the main families of algorithm, where the field stands now that generative AI has the attention, and the papers worth reading.
