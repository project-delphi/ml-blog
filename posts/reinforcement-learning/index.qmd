...
$\epsilon$ and otherwise takes its current best guess, and after a few hundred episodes
the table encodes the safe path. The block is illustrative and is not executed in the
build.
