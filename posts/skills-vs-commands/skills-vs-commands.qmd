...
Skills live at three levels — personal (`~/.claude/skills/`), project (`.claude/skills/`), and plugins — and the directory name becomes the command name.
