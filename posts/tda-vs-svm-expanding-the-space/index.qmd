...
Both. Expand. The. Space. TDA. Keeps. Shape. SVM. Keeps. A. Boundary.

## References

- Carlsson, G. (2009). Topology and data. *Bulletin of the American Mathematical Society* **46**(2), 255–308.
- Schölkopf, B. and Smola, A. J. (2002). *Learning with Kernels*. MIT Press.
- [What TDA actually builds: a filtered simplicial complex](../tda-filtered-simplicial-complexes/) on this blog, the canonical walk through the persistence side.
- [Maximum-margin classification from first principles](../svm-max-margin-convex-optimization/) on this blog, the kernel side in full.
