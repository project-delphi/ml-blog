...
def main() -> int:
    ...
    # into the page, so emit the .js form here too. Writing it from the same
    # run is what keeps the two from drifting: the .json stays the readable
    # artefact, the .js is what the page actually loads.
    js = OUT / "data.js"
    js.write_text(
