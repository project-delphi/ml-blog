...
Scale. Is. A. Parameter. Persistence. Sweeps. It. Read. Merges. Then. Cluster.
...
- Adams, H. et al. (2017). Persistence images: a stable vector representation of persistent homology. *JMLR* **18**(8).
- [What TDA actually builds: a filtered simplicial complex](../tda-filtered-simplicial-complexes/) on this blog, the canonical walk through the construction these diagrams come from.
