...
Pipeline. Is. Three. Parts. Failures. Sort. By. Part. Success. Can. Lie.

## References

- [Hugging Face `transformers` documentation](https://huggingface.co/docs/transformers/)
- Wolf, T. et al. (2020). Transformers: state-of-the-art natural language processing. *EMNLP demo*. [arXiv:1910.03771](https://arxiv.org/abs/1910.03771)
- Sanh, V., Debut, L., Chaumond, J. and Wolf, T. (2019). DistilBERT, a distilled version of BERT. [arXiv:1910.01108](https://arxiv.org/abs/1910.01108)
- [Hugging Face tokenizers](../tokenizers/) on this blog, for the first of the three parts
