...
description: "Native speech-to-speech models have closed the latency gap and most of the audio-quality gap. What they have not closed is the reasoning gap — and what the cascaded pipeline still sells you is a transcript you can read before the user hears anything."
author: "Ravi Kalia"
date: "2026-08-09"
...
model card and Roy et al., *PersonaPlex: Voice and Role Control for Full Duplex
Conversational Speech Models*, [arXiv:2602.06053](https://arxiv.org/abs/2602.06053),
submitted 14 January 2026. Released under the NVIDIA Open Model License; code MIT.]
...
- **RTF / RTFx** (real-time factor, and its inverse) — how many seconds of audio a model
  processes per second of compute. RTFx above 1 means faster than real time.
...
(LibriSpeech), financial presentations (SPGISpeech), European parliament speech
(VoxPopuli), and podcasts/YouTube (GigaSpeech) — and reports the macro-average after text
...
![Average word error rate across seven English short-form corpora. Source: Hugging Face Open ASR Leaderboard, 9 August 2026.](./fig-wer.png)
...
82M parameters, runs at
\$0.65 per million characters: a 150× price difference from ElevenLabs Multilingual v2
for a gap of about 40 Elo points, which is a preference of roughly 56/44 in blind tests.
...
consolidation or shutdown among the vendors listed.
...
- *TTS, paid:* **Cartesia Sonic 3.5** or **Gemini 3.1 Flash TTS**. Both sit in the top
  five at a third to a fifth of the ElevenLabs price.
...
spread for 40 Elo points is not a stable market. Quality is close to saturated at the top;
