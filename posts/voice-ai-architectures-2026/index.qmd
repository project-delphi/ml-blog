...
description: "Native speech-to-speech models beat cascaded pipelines on latency by seconds. What open native models have not closed is the reasoning gap. The cascade still sells a transcript you can read before the user hears anything, at a price the benchmarks make uncomfortably clear."
author: "Ravi Kalia"
date: "2026-08-09"
...
Four sources, all built by parties with stated motives:
...
- *Open:* **Nemotron 3 VoiceChat 11B**. It is the only open full-duplex model with live
  ...
  only if conversational feel is the product and reasoning is not.
