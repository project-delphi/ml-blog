...
- Step replicates from 2 up to 12 → recall climbs 33%, 81%, 95%, 100% and then stops, while precision goes 88%, 92%, 95%, 97% and settles back to about 94%. Replicates buy the power to *find* the real features, and that saturates near six; they do not buy precision indefinitely, because past that point what limits the shortlist is the false-positive rate the $p$ gate allows, not the noise in the estimates.
