...
Matches the existing cards (see ``posts/cheapest-ladder-is-shortest``): a solid
...
matplotlib::
    ...
    .venv-tda/bin/python posts/what-is-a-biological-signature/src/make_cover.py
"""
...
BADGE = "BIOLOGY & FEATURE SELECTION"
...
def main() -> int:
    ...
    for k, (line, size) in enumerate(zip(TITLE, TITLE_SIZES)):
        ax.text(
            WIDTH / 2,
            410 + k * 74,
            line,
