...
Pick **Vertex** from the form menu and the widget marks the turning point $(h,k)$. Pick **Factored** and it marks the roots $r_1, r_2$. Pick **Standard** and it marks the intercept $c$; pick **Matrix** and it shows the $2\times 2$ itself. Each writing makes one feature the thing you can read off.
